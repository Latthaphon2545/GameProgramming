...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.life = 100
        self.score = 0
        self.invulnerable = False  # New: Player's invulnerability state
        self.invulnerable_timer = 0  # New: Timer for invulnerability
    ...
    def update(self):
        ...
        if self.invulnerable:
            ...
            time_left = 3000 - (current_time - self.invulnerable_timer)
            print(time_left)
            if current_time - self.invulnerable_timer >= 3000:
                self.invulnerable = False  # End invulnerability after 3 seconds
                self.playerImages = [   pygame.image.load("JiJiSR/JiJiSR1.png").convert_alpha(),
                                        pygame.image.load("JiJiSR/JiJiSR1L.png").convert_alpha(),
                                        pygame.image.load("JiJiSR/JiJiSR1R.png").convert_alpha()
                                    ]
